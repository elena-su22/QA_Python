...
def transition_to_scene(i,loctypesx,herox,heroitemx,beastlistx,dangerbeastlistx):
    print(f'Текущая локация: {i}')
    print(type (i))
    print("Переход на локацию")
    if int(i)!=0:
        # heroitem = {}
        temp1 = location(int(i),loctypesx,herox,heroitemx,beastlistx,dangerbeastlistx)
        try:
            hero = temp1[0]
            heroitem = temp1[1]
        except:
