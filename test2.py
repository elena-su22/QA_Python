...
square1.fill((25, 25, 112))
font1 = pygame.font.Font(None,40)
text1 = font1.render('Надпись', False,'White')
...
while x == True:
    ...
    pygame.draw.rect(screenv,(25, 25, 112),(50,150,175,50)) ## pygame.draw.форма(rect-прямоугольник)(где-экран,(код цвета), (х(растояние от вертикальной границы экрана слева), (х(растояние от горизонтальной границы экрана сверху), х(размер вертикально),х(размер горизонтально))))
